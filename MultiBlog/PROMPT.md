...
5. **비교표-먼저 규칙** — 본문 작성 전 비교표를 먼저 완성. 본문은 비교표 기준으로 작성. 수정 시 비교표→본문 순으로 업데이트.
6. **출처 다양화** — 쿠팡 검색만이 아닌 제조사 공식 사이트, 다나와, 네이버쇼핑 등 3개 이상 소스 URL 필수. "쿠팡 검색" 단독 링크는 신뢰도 감점.
7. **초안 완성도 우선** — 반복 수정은 점수 하락 위험. 초안을 70+에 가깝게 작성하는 것이 목표. 3회 수정 후 하락 추세면 키워드 스킵.
