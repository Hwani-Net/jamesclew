...
SessionStart에서 Codex CLI / Ollama 서버(localhost:11434) 가동 상태를 자동 확인합니다. 5H 한계 도달 시 `/model sonnet`으로 전환합니다. copilot-api(GPT-4.1 프록시)는 2026-05 GitHub 차단으로 사용 불가. 로컬 모델(gemma4)은 보조 의견 전용.
