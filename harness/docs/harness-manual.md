...
│  │  (6계정 로테) │  │  (Codex CLI / Ollama)│  │  Ollama:11434   │  │
│  └───────────────┘  └───────────────┘  └─────────────────┘  │
└─────────────────────────────────────────────────────────────┘
                                │
                        ┌───────┘
...
| GPT-4.1 | `curl http://localhost:11434/api/chat` | 콘텐츠 톤, AI냄새 감지 | 콘텐츠 리뷰, 차별화 분석 |
...
**주의:** GPT-4.1은 Codex CLI / Ollama 프록시(`localhost:11434`) 경유. Codex CLI / Ollama 서버 실행 필수 (`ollama run gemma4 &`).
...
| 변수 | 용도 |
|------|------|
| `OPENAI_API_KEY` | Codex CLI / Ollama(GPT-4.1) 호출 |
