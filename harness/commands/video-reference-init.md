...
### 4-3. 외부 모델 교차 검수
주요 결과물 = Codex 단독 검수 + gemma4 보조 의견 (Self 검수 금지, 로컬 단독 판단 금지).
...
- PITFALL → `D:/jamesclew/harness/pitfalls/pitfall-NNN-{slug}.md` + `mcp__agentmemory__memory_save` 인덱싱 (gbrain 폐기 P-172)
