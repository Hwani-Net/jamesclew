...
- `/blog-publish D:/AI 비즈니스/smartreview/drafts/2026-04-12-keyword/` — 특정 초안 지정

## 산출물
- `D:/AI 비즈니스/smartreview/published/{slug}/index.html` — 발행된 HTML
- `D:/AI 비즈니스/smartreview/published/{slug}/meta.json` — 발행 메타데이터 (URL, 발행일, 버전)
...
| 항목 | 경로 |
|------|------|
| 입력: 마크다운 | `D:/AI 비즈니스/smartreview/drafts/{slug}/draft.md` |
| 입력: 메타데이터 | `D:/AI 비즈니스/smartreview/drafts/{slug}/meta.json` (SEO 필드) |
| 입력: 상태 | `D:/AI 비즈니스/smartreview/drafts/{slug}/status.json` (status=ready/complete) |
| 출력: HTML | `D:/AI 비즈니스/smartreview/public/{slug}/index.html` |
| 출력: 발행 메타 | `D:/AI 비즈니스/smartreview/public/{slug}/meta.json` |
...
```bash
bash harness/scripts/blog-publish.sh D:/AI 비즈니스/smartreview/drafts/{slug}/
```
...
5. 템플릿에 주입 → `D:/AI 비즈니스/smartreview/public/{slug}/index.html` 저장
